...
const Sidebar = ({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 z-50 ${getSidebarWidth()} h-full bg-white bg-opacity-90 backdrop-blur-lg border-r border-white border-opacity-30 transition-all duration-300 ease-in-out ${
      ...
      >
          ...
          >
            ...
            {!isCollapsed && (
              <div className="ml-2.5">
                <h1 className="text-gray-800 font-bold text-base">Trek Link</h1>
        ...
        <div className="p-2.5 border-t border-white border-opacity-30 flex-shrink-0 hidden lg:block">
          <button
            onClick={onToggleCollapse}
            className={`w-full flex items-center justify-center ${
              isCollapsed ? "p-2.5" : "p-2"
            } rounded-lg text-gray-700 hover:text-purple-700 hover:bg-white hover:bg-opacity-60 transition-all duration-300 group relative`}
